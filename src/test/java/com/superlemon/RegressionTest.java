...
//		webDB.driver.manage().window().setSize(d);
	...
	// @Test(description = "Verify that at least one agent should be enabled for the
	// store and the user should not be allowed to disable all the agents..",groups
	// = "PersonalWidget",priority=6)
	// public void verifyAtLeastOneAgentEnabled() throws FileNotFoundException,
	// InterruptedException, IOException {
	// CommonFunctions.verifyPersonalWidgetPage();
	// flag = PersonalWidgetPage.checkAtLeastOneAgentEnabled();
	// assertEquals(true, flag);
	//
	// }
	...
	public void checkGreetingsCardSettings() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyPersonalWidgetPage();
		flag = WidgetPage.checkupdatedGreetingsSettingOnStore();
		assertEquals(true, flag);
	}
	...
	// @Test(description = "Verify Add Agent", groups = "PersonalWidget",priority=6)
	// public void verifyAddAgent() throws FileNotFoundException,
	// InterruptedException, IOException {
	//
	// CommonFunctions.verifyPersonalWidgetPage();
	// flag = PersonalWidgetPage.verifyAddAgent();
	// assertEquals(true, flag);
	//
	// }
...
//	@Test(description = "Verify that user should be shown a validation for empty email id if user tries to submit without email id..", groups = "OptinNumber", priority = 25)
...
//	@Test(description = "Verify that user is given validation for the invalid email Id provide while exporting the optin list...", groups = "OptinNumber", priority = 27)
	...
	// // @Test(description = "verify that \"Disable opt-in widget from storefront\"
	// // option should be disabled before user gets approval for collect opt-in
	// from
	// // checkout..")
	// // public void checkInvalidEmptyDate() throws FileNotFoundException,
	// // InterruptedException, IOException {
	// // //flag = CommonFunctions.verifyLoginPage("accesstoken");
	// // if (flag) {
	// // CommonFunctions.verifyOptinNumbersPage();
	// // flag = OptinNumbersPage.verifyInvalidOrEmptyDateExport();
	// // }
	// // assertEquals(false, flag);
	// //
	// // }
	//
//	@Test(description = "Verify that only 90 days optin list data can be exported ...", groups = "OptinNumber", priority = 28)
	...
	@Test(description = "Verify that user is able to confirm optin from thank you page for number added in the checkout details ...", groups = "OptinNumber", priority = 29)
	...
	@Test(description = "Verify That all optin checkboxes should be disabled if user selects the DIsable optin from Storefront option.", groups = "AdminConfig", priority = 33)
	...
	@Test(description = "Verify That all optin checkboxes should be enabled if user has ewnabled the checkboxes form the Admin configuration Page", priority = 34)
	...
	@Test(description = "Verify that user us able to see the optin pop up on the store on the pages selected on the store.", groups = "AdminConfig", priority = 35)
	...
	@Test(description = "Verify that user is able to opt in successfully via widget on the storefront.", groups = "AdminConfig", priority = 36)
	...
	@Test(description = "verify that user should be able to change \"Storefront Opt-in Widget Language\" as per requirement..", groups = "AdminConfig", priority = 37)
	...
	//@Test(description = "Verify that country code validations should be present for empty country code entered in the opt in pop up.", groups = "AdminConfig", priority = 38)
	...
	@Test(description = "Verify that country code validations should be present for empty phone entered in the opt in pop up..", groups = "AdminConfig", priority = 39)
	...
	@Test(description = "Verify that country code validations should be present for invalid country code and phone number entered in the opt in pop up.", groups = "AdminConfig", priority = 40)
	...
	//
	@Test(description = "Verify that user is able to opt in successfully via widget from the thank you page.", groups = "AdminConfig", priority = 41)
	...
	@Test(description = "verify that the note is visible on UI - \"Note: Opt-in widget is enabled by default for the “Thank you page“ if you enable anyAutomated Orders CRM template.", priority = 42)
	...
	// sheet after clicking on \" ? \" beside country code.", groups =
	// "AdminConfig", priority = 45)
	...
	@Test(description = "verify that user should be able to see preview of thank you page widget after clicking on \"Preview thank you page widget\"hyperlink", groups = "AdminConfig", priority = 46)
	...
	@Test(description = "verify that user should be able to see preiew of opt-in widget after clicking on \"Preview opt-in widget\" hyperlink as perselected langauge.", groups = "AdminConfig", priority = 47)
	...
	// //
	// ////--------------------------------------------WhatsAppAPIPage-----------------------------------------------
	@Test(description = "Verify Validations on WhatsApp API Page", groups = "WhatsAppAPI", priority = 72)
	@Ignore
	...
	@Test(description = "Verify Facebook Business Manager ID", groups = "WhatsAppAPI", priority = 73)
	@Ignore
	...
	@Test(description = "Verify WhatsApp Number", groups = "WhatsAppAPI", priority = 74)
	@Ignore
	...
	// //
	// --------------------------------------------WhatsAppExtensionPage------------------------------------------
	//// @Test(description = "Verify that when user enables cod template the note
	//// // should appear below template - \"\r\n"
	//// + "Note: If both COD Order Confirmation and regular Order Confirmation
	//// // templates are enabled, "
	//// + "then the regular Order Confirmation message will be sent after your
	//// // customer confirms a COD order.\".", groups = "WhatsAPPExtension")
	//// public void verifyExtensionLogin() throws FileNotFoundException,
	//// // InterruptedException, IOException {
	//// flag = WhatsappExtensionPage.verifyExtensionLogin();
	//// assertEquals(true, flag);
	//// }
	////
	//// @Test(description = "Verify that when user enables cod template the note
	...
	//// + "then the regular Order Confirmation message will be sent after your
	//// // customer confirms a COD order.\".", groups = "WhatsAPPExtension")
	//// public void checkExtensionLogout() throws FileNotFoundException,
	//// // InterruptedException, IOException {
	//// // flag = WhatsappExtensionPage.verifyExtensionLogin();
	//// // if (flag) {
	//// flag = WhatsappExtensionPage.verifyExtensionLogout();
	//// assertEquals(true, flag);
	//// }
	////
	//// // }
	...
	//// + "then the regular Order Confirmation message will be sent after your
	//// // customer confirms a COD order.\".", groups = "WhatsAPPExtension")
	//// public void checkExtensionQuickReplyCreation() throws
	//// FileNotFoundException,
	//// // InterruptedException, IOException {
	//// // flag = WhatsappExtensionPage.verifyExtensionLogin();
	//// // if (flag) {
	//// flag = WhatsappExtensionPage.verifyQuickReplyCreationOnExtension();
	//// assertEquals(true, flag);
	//// }
	////
	//// // }
	...
	//// + "then the regular Order Confirmation message will be sent after your
	//// // customer confirms a COD order.\".", groups = "WhatsAPPExtension")
	//// public void checkCreatedExtensionTemplateOnExtension() throws
	//// // FileNotFoundException, InterruptedException, IOException {
	//// //flag = CommonFunctions.verifyLoginPage("accesstoken");
	//// // if (flag) {
	//// CommonFunctions.verifyTemplatesPage();
	//// flag = WhatsappExtensionPage.createExtensionTemplatesAndCheckOnExtension();
	//// assertEquals(true, flag);
	//// }
	////
	//// // }
	...
	@Test(description = "Verify that user is able to add Percentage Discount in CART Template.", groups = "Templates", priority = 78)
	...
	@Test(description = "Verify that user is able to add Percentage Discount in Order Confirmation Template..", groups = "Templates", priority = 79)
	...
	@Test(description = "Verify that user is able to add Fixed Discount in Abandoned Cart Template.", groups = "Templates", priority = 80)
	...
	@Test(description = "Verify that user is able to add Fixed Discount in Order COnfirmation Template.", groups = "Templates", priority = 81)
	...
	@Test(description = "Verify that user is able to add Fixed Discount in Order Shipment Template.", groups = "Templates", priority = 82)
	...
	@Test(description = "verify that settings button gets enabled when user enables the Automated Template Messaging..", groups = "Templates", priority = 89)
	...
	@Test(description = "Verify that user should be able to enable / disable any extension template as per requirement.", groups = "Templates", priority = 93)
	...
	public void VerifyTemplateNameNotEmpty() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.VerifyTemplateNameNotEmpty();
		assertEquals(true, flag);
	}

	@Test(description = "verify that user should not be able to create template keeping the textboxes empty,"
			+ " \"Template name can not be empty\" error message shoul be displayed.", groups = "Templates", priority = 95)
	public void VerifyDuplicateTemplateName() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.VerifyDuplicateTemplateName();
		assertEquals(true, flag);
	}
	...
	public void VerifyTemplateContents() throws FileNotFoundException, InterruptedException, IOException {
		flag = CommonFunctions.verifyMessagingPage();
		// flag = AutomationPage.VerifyTemplateContents();
		assertEquals(true, flag);
	}
	...
	public void VerifyDiscardBtnOnCreateTemplate() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.VerifyDiscardBtnOnCreateTemplate();
		assertEquals(true, flag);
	}
	...
	public void VerifyEditTemplateName() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.VerifyEditTemplateName();
		assertEquals(true, flag);
	}
	...
	public void checkEditTemplate() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.createAndEditTemplateName();
		assertEquals(true, flag);
	...
	public void VerifyCategoryForTemplate() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyMessagingPage();
		flag = AutomationPage.VerifyCatogeryForTemplate();
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify that user should redirect properly on Superlemon login site after clicking on hyperlink \"beta-app.superlemon.xyz\".", groups = "ManualMessaging", priority = 114)
	public void verifyHyperlinkSettings() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyHyperlinkSettings();
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify that user should be able to see 2 sub-sections below settings on settings page - 1. Tags 2. Messaging Templates.", groups = "ManualMessaging", priority = 116)
	...
	@Test(description = "Verify that user should be able to see 2 buttons - 1. View Templates and 2. Create Template in messaging templates section.", groups = "ManualMessaging", priority = 118)
	public void verifyMessagingTemplatesButtons() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyMessagingTemplatesButtons();
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify user should be able to see all created templates after clicking on \"View Temlates\" button.", groups = "ManualMessaging", priority = 120)
	...
	@Test(description = "Verify user should be able to see Add message Template pop-up after clicking on Create Template button. \r\n"
			+ "on this user should be able to see - Name , Message , Select Category , Create Discount Code - Discount value (1-100) and some useful tags listing.", groups = "ManualMessaging", priority = 129)
	public void verifyCreateTemplateField() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyCreateTemplateField();
		assertEquals(true, flag);
	}

	@Test(description = "Verify user should not be able to create 2 templates with same name in irrespective of category ( template name should be unique). ", groups = "ManualMessaging", priority = 130)
	public void verifyDuplicateTemplate() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyDuplicateTemplate();
		assertEquals(true, flag);
	}

	@Test(description = "Verify user should be able to see error message when user tries to save template w/o adding name.\r\n"
			+ "\"Template name can not be empty\". ", groups = "ManualMessaging", priority = 131)
	public void verifyEmptyTemplateNameField() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyEmptyTemplateNameField();
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify user should be able to see error message when user tries to save template w/o adding discount value when the create discout code is selected.\r\n"
			+ "\"Disount value cannot be empty\".", groups = "ManualMessaging", priority = 134)
	public void verifyEmptyTemplateDiscountField() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyEmptyTemplateDiscountField();
		assertEquals(true, flag);
	}
	...
	public void verifyEditTemplate() throws FileNotFoundException, InterruptedException, IOException {
		...
		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifyEditTemplate();
		assertEquals(true, flag);
	}
	...
	// @Test(description = "Verify that user redirects to selected option (whatsapp
	// desktop app) after clicking on send button on send message pop-up.", groups =
	// "ManualMessaging",priority = 6)
	// public void verifyCBP() throws FileNotFoundException,
	// InterruptedException, IOException {
	//
	// flag = WhatsAppAPIPage.verifyConversationPricing();
	// assertEquals(true, flag);
	// }
	// ----------------------------------------------------Analytics
	// Page----------------------------------------------------------------------------
	@Test(description = "Verify that user is able to see the chat click count reflected on Analytics page.", groups = "ManualMessaging", priority = 165)
	public void checkChatClickCount() throws Exception {
	...
	//
	@Test(description = "Verify that user is able to see the share click count reflected on Analytics page.", groups = "ManualMessaging", priority = 166)
	public void checkShareCount() throws Exception {
		flag = AnalyticsPage.verifyClickcount();
		if (flag) {
			flag = DriverBase.verifyResponseAPI("CronGetClickCount");
			if (flag) {
	...
	//
	@Test(description = "Verify that user is able to see the chat and share click count reflected for specific date range on Analytics page.", groups = "ManualMessaging", priority = 167)
	public void checkDateSpecificClickAnalytics() throws FileNotFoundException, InterruptedException, IOException {

		CommonFunctions.verifyAnalyticsPage();
		flag = AnalyticsPage.verifyChatClickCountForSpecificDateRange();
		assertEquals(true, flag);
	}
...
//	------------------------------------------------------------Email Channel Cases----------------------------------------------------------------
	@Test(description = "Verify that settings gets enabled on enabling the email template for the respective type", groups = "Email Templates", priority = 169)
	...
	@Test(description = "Verify that settings gets disabled on disabling the email template for the respective type", groups = "Email Templates", priority = 170)
	...
	@Test(description = "Verify that user is able to add Percentage Discount in CART email Template.", groups = "Email Templates", priority = 171)
	public void checkAddDiscountABCARTEmailTemplate() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.addDiscountToABCartTemplate();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to add Percentage Discount in Order Confirmation email Template..", groups = "Email Templates", priority = 172)
	public void checkAddDiscountOrderConfirmationEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.addDiscountTypeToOrderConfirmationEmailTemplate();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to add Fixed Discount in Abandoned Cart email Template.", groups = "Email Templates", priority = 173)
	public void checkAddFixedDiscountABCARTEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.addCouponToABCartTemplate();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to add Fixed Discount in Order Confirmation  email Template.", groups = "Email Templates", priority = 174)
	public void checkAddFixedDiscountOderConfirmationEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.addCouponToOrderConfirmationTemplate();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to add Fixed Discount in Order Confirmation email  Template.", groups = "Email Templates", priority = 175)
	public void checkTrackingUrlConfigurationOrderShipmentEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.verifyOrderShipmentTrackingUrlConfiguration();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that validation is given for invalid country code provided for COD confirmation page in COD email Template settings.", groups = "Email Templates", priority = 176)
	public void checkCountryCodeValidationCODEmailTemplateCallSetting()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailTemplatesPage();
		flag = EmailTemplatesPage.verifyInvalidCountryCodeOnCodConfirmationPage();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that validation is given for invalid phone Number Provided for COD confirmation page in COD email Template settings..", groups = "Email Templates", priority = 177)
	public void checkPhoneNumberValidationCODEmailTemplateCallSetting()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.verifyInvalidPhoneOnCodConfirmationPage();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that validation is given for invalid email id provided for COD confirmation page e in COD email Template settings..", groups = "Email Templates", priority = 178)
	public void checkEmailValidationCODEmailTemplatesCallSetting()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.verifyInvalidEmailOnCodConfirmationPage();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to update the call and Email to be provided on COD Confirmation page e in COD email Template settings..", groups = "Email Templates", priority = 179)
	public void checkEmailTemplateCODConfirmationPageCallAndEmailDetailsAddition()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.verifyCallAndEmailOptionSelectionCODSettings();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to update the COD tags in COD settings of Automated Templates e in COD email Template settingss.", groups = "Email Templates", priority = 180)
	public void checkCODEmailTemplateTagsUpdation() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.updateCODTags();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is select COD order cancellation on either cancellation or No response or both e in COD email Template settings", groups = "Email Templates", priority = 181)
	public void checkSelectUnselectCODEmailTemplateCancellationCheckboxes()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailTemplatesPage();
		if (flag) {
			flag = EmailTemplatesPage.selectUnselectCancellationAndNoResponseCheckBox();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is able to add shopify brandName in the email templates", groups = "Email Templates", priority = 182)
	...
	@Test(description = "Verify that user is able to add custom brandName in the email templates", groups = "Email Templates", priority = 183)
	...
	@Test(description = "Verify that user add support Email in the Email Template body for all available email templates", groups = "Email Templates", priority = 184)
	public void checkSupportEmailAdditionInEmailBody() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailConfigurationPage();
		if (flag) {
			flag = EmailConfigurationPage.addAndVerifySupportEmailInTemplates();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is given validation message on entering invalid support email and saving it", groups = "Email Templates", priority = 185)
	public void checkValidationEmptyInvalidSupportEmails()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailConfigurationPage();
		if (flag) {
			flag = EmailConfigurationPage.verifyEmptySupportEmailOnSave();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user is given validation message on entering invalid  or empty brandName and saving it", groups = "Email Templates", priority = 186)
	public void checkEmptyValidationForBrandName() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = CommonFunctions.verifyEmailConfigurationPage();
		if (flag) {
			flag = EmailConfigurationPage.verifyEmptyCustomBrandNameValidation();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user gets navigated to the Email page on clicking on Email Logs tab.", groups = "Email Logs", priority = 187)
	...
	@Test(description = "Verify that user is able to view names in table.", groups = "Email Logs", priority = 188)
	...
	@Test(description = "Verify that user is able to filter order,name and type column  in Email Logs Page..", groups = "Email Logs", priority = 189)
	...
	@Test(description = "Verify that user is able to see timestamp in Attempted column in Email Logs Page.", groups = "Email Logs", priority = 190)
	...
	@Test(description = "Verify that user is able to search by name in Name Textbox in Email Logs.", groups = "Email Logs", priority = 191)
	...
	@Test(description = "Verify that user is able to search by order in orderid searchbar in Email Logs.", groups = "Email Logs", priority = 192)
	...
	@Test(description = "Verify that user should be able to clear all the filters checked in \"Type\" field by clicking on Clear in type field in Email Logs.", groups = "Email Logs", priority = 193)
	public void verifyClearAllButtonOnFilterInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.verifyClearAllButtonOnFilter();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see status of the automated messages in status column.", groups = "Email Logs", priority = 194)
	public void verifyStatusColumnInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.verifyStatusColumn();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see Type of order - Cart Recovery , Order CRM , Cash on Delivery and Order tracking. ", groups = "Email Logs", priority = 195)
	public void VerifyTypeOfOrderDisplayInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyTypeOfOrderDisplay();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that when no filters are selected the \"Clear\" should be disabled and it should be enabled when any of field id checked inType field.", groups = "Email Logs", priority = 196)
	public void VerifyClearButtonInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyClearButton();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see all the selected filters below search by order id textbox.", groups = "Email Logs", priority = 197)
	public void VerifyFilterTextBelowOrderIDInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyFilterTextBelowOrderID();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to dis-select filters appearing below search by order id textbox by clicking on X icon in Email Logs Page.", groups = "Email Logs", priority = 198)
	public void VerifyClearFilterTagsInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyClearFilterTags();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see filtered results as per selected filters.", groups = "MessageLogs in Email Logs", priority = 199)
	public void VerifyFilterResultInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyFilterResult();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to clear the name in\"Search by Name\" field by clicking on \"Clear\" in Search by namefield.", groups = "Email Logs", priority = 200)
	public void VerifyClearSearchByNameTxtboxInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.ClearSearchByNameTxtbox();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that \"Clear\" should be disabled by default and it should be enabled when you enter text in Search by Name textbox.", groups = "Email Logs", priority = 201)
	public void VerifyClearSearchByNameTxtboxEnableDisableInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyClearSearchByNameTxtboxEnableDisable();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to sort Message logs by Ascending or Descending on Order , Name , Amount Columns. ", groups = "Email Logs", priority = 202)
	public void VerifySortingByAscAndDescInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyOrderSorting();
		Thread.sleep(1000);
		flag = EmailLogsPage.VerifyNameSorting();
		Thread.sleep(1000);
		flag = EmailLogsPage.VerifyAmountSorting();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see 10 message logs records on one page.", groups = "Email Logs", priority = 203)
	public void VerifyDataTableRowCountInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyDataTableRowCount();
		assertEquals(true, flag);
	}

	@Test(description = "verify that user should be able to navigate to next page by clicking on \">\" to see more message logs history.", groups = "Email Logs", priority = 204)
	public void VerifyPageNavigationInEmailLogs() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyPageNavigation();
		assertEquals(true, flag);
	}

	@Test(description = "Verify That user is able to see the timestamp for the attempted message logs in Attempted section.", groups = "Email Logs", priority = 205)
	public void VerifyTimestampInAttemptedSectionInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyTimestamp();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see Amount as per selected Currency in Email Logs.", groups = "Email Logs", priority = 206)
	...
	@Test(description = "Verify that message logs by default are sorted as per the latest timestamp in Email LOgs.", groups = "Email Logs", priority = 207)
	public void VerifyLatestSortedTimestampInEmailLogs()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailLogsPage();
		flag = EmailLogsPage.VerifyLatestSortedTimestamp();
		assertEquals(true, flag);
	}

	@Test(description = "Verify Order Confirmation is displayed in Message Logs", groups = "Email Logs", priority = 208)
	public void VerifyOrderConfirmationMessageLogInEmailLogss()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		flag = EmailLogsPage.VerifyOrderConfirmationMessageLog();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that discount text gets included in the abcart template on enabling discount from abcarty email template settings.", groups = "Email Logs", priority = 209)
	public void checkDiscountTextInclusionInABCartEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailTemplatesPage();
		flag = EmailTemplatesPage.verifyDiscountTextInclusionInAbCartEmailTemplate();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that discount text gets included in the order template on enabling discount from order email template settings.", groups = "Email Logs", priority = 210)
	public void checkDiscountTextInclusionInOrderEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailTemplatesPage();
		flag = EmailTemplatesPage.verifyDiscountTextInclusionInOrderEmailTemplate();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that discount text gets excluded in the order template on enabling discount from order email template settings.", groups = "Email Logs", priority = 211)
	public void checkDiscountTextExclusionInOrderEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailTemplatesPage();
		flag = EmailTemplatesPage.verifyDiscountTextExclusionInOrderEmailTemplate();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that discount text gets excluded in the abcart template on enabling discount from abcarty email template settings.", groups = "Email Logs", priority = 212)
	public void checkDiscountTextExclusionInABCartEmailTemplate()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		CommonFunctions.verifyNewStoreLoginPage("POI45QAtoken");
		CommonFunctions.verifyEmailTemplatesPage();
		flag = EmailTemplatesPage.verifyDiscountTextInclusionInAbCartEmailTemplate();
	...
	@Test(description = "Verify that 2 Transaction templates are added in automated templates - 1. Payment Successful 2. Order Cancellation. ", groups = {
			"regression" }, priority = 214)
	public void verifyPricingChartHyperlinks()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		flag = CommonFunctions.verifyTemplatesPage();
		if (flag) {
			flag = AutomationPage.verifyPaymentSuccessfullHyperLinks();
			if (flag) {
				flag = AutomationPage.verifyTransactionShopifyHyperLink();
				if (flag) {
					flag = AutomationPage.verifyOrderCancellationHyperLinks();
				}
			}
		}
		assertEquals(true, flag);
	...
	@Test(description = "Verify that Include discount coupon textbox working properly or not in payment successful template settings pop-up.", groups = {
			"regression" }, priority = 216)
	public void verifyDiscountInTemplate()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		flag = AutomationPage.verifyDiscount();
		if (flag) {
			flag = AutomationPage.verifyFixedDiscount();
		}
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify that user should be able include or exclude discount as per requirement using \"Include discount coupon\" checkbox in Cross-Sell and Customer Winback settings pop-up.", groups = {
			"regression" }, priority = 220)

	public void verifyPromotionalIncludeExcludeDicount()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		flag = AutomationPage.verifySettingsNote();
		if (flag) {
			flag = AutomationPage.verifyIncludeExcludeDiscount();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able include or exclude discount as per requirement using \"Include discount coupon\" checkbox in Cross-Sell and Customer Winback settings pop-up.", groups = {
			"regression" }, priority = 221)

	public void verifyCrossSellDicountInterval()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		flag = AutomationPage.verifyCrossSellDiscount();
		if (flag) {
			log.info("verified Cross sell discount");
			flag = AutomationPage.verifyCrossSellFixedDiscount();
			if (flag) {
				log.info("verified Cross sell fixed discount");
				flag = AutomationPage.verifyCrossSellInterval();
			}
		}
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify that user should be able include or exclude discount as per requirement using \"Include discount coupon\" checkbox in Cross-Sell and Customer Winback settings pop-up.", groups = {
			"regression" }, priority = 222)

	public void verifyCustomerWinbackFeedBackDicountInterval()
			throws FileNotFoundException, InterruptedException, IOException, ParseException {
		flag = AutomationPage.verifyCustomerWinbackDiscount();
		if (flag) {
			flag = AutomationPage.verifyCustomerWinbackFixedDiscount();
			if (flag) {
				flag = AutomationPage.verifyCustomerWinbackInterval();
				if (flag) {
					flag = AutomationPage.verifyFeedBackInterval();
				}
			}
		}
		assertEquals(true, flag);
	...
	@Test(description = "Verify that user should be able include or exclude discount as per requirement using \"Include discount coupon\" checkbox in Cross-Sell and Customer Winback settings pop-up.", groups = {
			"regression" }, priority = 224)
	public void verifyMiniumumOffsetvalue() throws Exception {
		flag = WidgetPage.verifyMinimumOffset();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able include or exclude discount as per requirement using \"Include discount coupon\" checkbox in Cross-Sell and Customer Winback settings pop-up.", groups = {
			"regression" }, priority = 225)
	...
	@Test(description = "Verify user is able to select design in spin wheel", groups = {
			"regression" }, priority = 230)
	...
	public void verifyDisableAnalytics() throws FileNotFoundException, InterruptedException, IOException {
		...
		if (flag) {
			flag = AnalyticsPage.verifyAbandonedCurrentlyDisableEnable();
			if (flag) {
	...
	@Test(description = "Verify that when select template and click on send it is redirecting to selected customer whats app number or not "
			+ "Verify on clicking submit without selecting the check box a warning is shown or not."
			+ "Verify campaign is submitted with check box being selected"
			+ "Verify on clicking Learn more, user should be redirected to the get opt-in page", priority = 242)
...
//		if (flag) {
//			log.info("Verified InputMarket Campaign");
		flag = CampaignsPage.verifyInvalidInputMarketCampign();
		if (flag) {
			log.info("Verified Invalid Inputs");
			flag = CampaignsPage.verifyLearnmoreRedirection();
			if (flag) {
				log.info("Verified page redirection after click Learn more");
				flag = CampaignsPage.verifyCreateMarketCampign();
//				if (flag) {
//					log.info("Verified Create Market campaign");
//					flag = MarketCampaignsPage.verifyGuideMarketCampign();
//				}
//			}
			}
		}
...
//		}
	...
	@Test(description = "Verifying Change Free plan recommended", priority = 254)
	...
	@Test(description = "Verify that user should be able to re-direct properly after clicking on \\\"Know More\\\" button in old free.", priority = 255)
	public void VerifyOldFreeKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDFREE);
		if (flag) {
			flag = PlansPage.verifyKnowmore();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to re-direct properly after clicking on \"Know More\" button in old pro.", priority = 256)
	public void VerifyOldProKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDPRO);
		if (flag) {
			flag = PlansPage.verifyKnowmore();
		}
		assertEquals(true, flag);
	...
	@Test(description = "Verify that user should be able to re-direct properly after clicking on \"Know More\" button in old ultimate.", priority = 257)
	public void VerifyOldUltimateKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDULTIMATE);
		if (flag) {
			flag = PlansPage.verifyKnowmore();
		}
		assertEquals(true, flag);
	...
	@Test(description = "Verify that know more button is redirecting to plans page or not ", priority = 258)
	public void VerifyNewFreeKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
	...
	@Test(description = "Verify that on small business plan promotional tile knoe more button is redirecting to  plans  page  or not ", priority = 259)
	public void VerifyNewFreePromotionalKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.FREE);
		if (flag) {
			flag = PlansPage.verifyPromtionalKnowmore();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that on small business plan promotional tile knoe more button is redirecting to  plans  page  or not ", priority = 260)
	public void VerifyGrowthPromotionalKnowMoreBtn() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
	...
	@Test(description = "Verify that user should be able to see information note about newly release plan ( old free details ). ", priority = 261)
	public void VerifyOldFreePlanNote() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDFREE);
		if (flag) {
			flag = PlansPage.verifyPlanNote();
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see information note about newly release plan ( old pro details ). ", priority = 262)
	public void VerifyOldProPlanNote() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDPRO);
		if (flag) {
			flag = PlansPage.verifyPlanNote();
	...
	@Test(description = "Verify that user should be able to see information note about newly release plan ( old ultimate details ). ", priority = 263)
	public void VerifyOldUltimatePlanNote() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDULTIMATE);
		if (flag) {
			flag = PlansPage.verifyPlanNote();
	...
	@Test(description = "Verify that user should be able to see feature list about newly release plan ( old free details ). ", priority = 264)

	public void VerifyOldFreeFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDFREE);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.OLDFREE);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see feature list about newly release plan ( old pro details ). ", priority = 265)

	public void VerifyOldProFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDPRO);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.OLDPRO);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see feature list about newly release plan ( old ultimate details ) ", priority = 266)

	public void VerifyOldUltimateFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.OLDULTIMATE);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.OLDULTIMATE);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see feature list about newly release plan ( free plan details ). ", priority = 267)

	public void VerifyFreeFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.FREE);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.FREE);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to see feature list about newly release plan ( Growth plan details ). ", priority = 268)

	public void VerifyGrowthFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.GROWTH);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.GROWTH);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that shared team inbox feature tile  is there or not for enterprise and  new user "
			+ "Verify that shared inbox feature correct description is showing or not ", priority = 269)

	public void VerifyEngageFeatureList() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyHomePage();
		flag = PlansPage.changePlanAPI(PlansPageLocators.ENGAGE);
		if (flag) {
			flag = PlansPage.verifyPlansFeatureList(PlansPageLocators.ENGAGE);
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to update plan using \"Update Plan\" Button.", priority = 270)

	public void verifyOldFreeUpdatePlan() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDFREE);
			if (flag) {
				flag = PlansPage.verifyUpdatePlan();
			}
		}
		assertEquals(true, flag);
	}

	@Test(description = "Verify that user should be able to update plan using \"Update Plan\" Button in old pro.", priority = 271)

	public void verifyOldProUpdatePlan() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDPRO);
			if (flag) {
	...
	@Test(description = "Verify that user should be able to update plan using \"Update Plan\" Button in old ultimate.", priority = 272)

	public void verifyOldUltimateUpdatePlan() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDULTIMATE);
			if (flag) {
	...
	@Test(description = "Verify that user should be able to update plan using \"Update Plan\" Button in free plan.", priority = 273)

	public void verifyFreeUpdatePlan() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.FREE);
			if (flag) {
	...
	@Test(description = "Verify that user should be able to update plan using Get Started button\r\n"
			+ "	Verify that entrprise promotional tile is showing in all the plans or not\r\n"
			+ "	Verify that if user is not subscribe to enterprise then subscribe option of enterprise plan is showing or not for other plan in shared inbox feature - old free", priority = 274)

	public void verifyOldFreeGetStarted() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDFREE);
			if (flag) {
				flag = PlansPage.verifySharedInboxPlans();
				if (flag) {
					flag = CommonFunctions.verifyHomePage();
					if (flag) {
						flag = PlansPage.verifyGetStartedButton();
					}
				}
			}
		}
	...
	@Test(description = "Verify that user should be able to update plan using \"Get Started\" button\r\n"
			+ "	Verify that entrprise promotional tile is showing in all the plans or not\r\n"
			+ "	Verify that if user is not subscribe to enterprise then subscribe option of enterprise plan is showing or not for other plan in shared inbox feature - old pro", priority = 275)

	public void verifyOldProGetStarted() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDPRO);
			if (flag) {
	...
	@Test(description = "Verify that user should be able to update plan using \"Get Started\" button\r\n"
			+ "	Verify that entrprise promotional tile is showing in all the plans or not\r\n"
			+ "	Verify that if user is not subscribe to enterprise then subscribe option of enterprise plan is showing or not for other plan in shared inbox feature - old ultimate", priority = 276)

	public void verifyOldUltimateGetStarted() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.OLDULTIMATE);
			if (flag) {
	...
	@Test(description = "Verify that on small business plan promotional tile get started button is redirecting to shopify page  or not\r\n"
			+ "	Verify that entrprise promotional tile is showing in all the plans or not\r\n"
			+ "	Verify that if user is not subscribe to enterprise then subscribe option of enterprise plan is showing or not for other plan in shared inbox feature - free plan", priority = 277)

	public void verifyFreeGetStarted() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.FREE);
			if (flag) {
	...
	@Test(description = "Verify that on small business plan promotional tile get started button is redirecting to shopify page  or not\r\n"
			+ "	Verify that entrprise promotional tile is showing in all the plans or not\r\n"
			+ "	Verify that if user is not subscribe to enterprise then subscribe option of enterprise plan is showing or not for other plan in shared inbox feature - growth plan", priority = 278)

	public void verifyGrowthGetStarted() throws Exception {
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.changePlanAPI(PlansPageLocators.GROWTH);
			if (flag) {
	...
	@Test(description = "Verify that user should be able to see feature list - 1.  Automated Messages 2. Spin the wheel 3. Chat Widget 4. Share Widget 5.marketing campaign 6.customer group\r\n"
			+ "	Verify that feature list content should be proper or not on any  plan (new user)", priority = 279)
	public void verifyFeatureListNewStore() throws Exception {
		CommonFunctions.verifyNewStoreLoginPage("NewStoreToken");
		flag = CommonFunctions.verifyHomePage();
		if (flag) {
			flag = PlansPage.verifyNewStoreFeatureList();
		}
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify that once shared inbox setup is live and support number is set as waba number then new templates is showing or not ", priority = 281)

	public void VerifyAbdandedCartNewTemplateMsg() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("SharedInbox_Token");
		CommonFunctions.verifySharedTeamInboxPage();
		flag = AutomationPage.VerifyAbdandedCartNewTemplateMsg();
		assertEquals(true, flag);
	}

	@Test(description = "Verify that once shared inbox setup is live and support number is not  set as waba number then new templates is showing or not ", priority = 282)

	public void VerifyAbdandedCartOldTemplateMsg() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyNewStoreLoginPage("SharedInbox_Token");
		flag = AutomationPage.VerifyAbdandedCartOldTemplateMsg();
		assertEquals(true, flag);
	}

	@Test(description = "verify Engage plan content", priority = 283)
	public void VerifyEngagePlanContent() throws FileNotFoundException, InterruptedException, IOException {

		flag = PlansPage.verifyEngagePlanContent();

		assertEquals(true, flag);
	}

	@Test(description = "verify Engage plan subscribe button redirection", priority = 284)
	public void VerifySubscribeButtonRedirection() throws FileNotFoundException, InterruptedException, IOException {

		flag = PlansPage.verifySubscribeButtonRedirection();

		assertEquals(true, flag);
	}

	@Test(description = "verify Engage plan greeting tile", priority = 285)
	public void VerifyEngagePlanGreetingTile() throws FileNotFoundException, InterruptedException, IOException {

		flag = PlansPage.verifyEngagePlanTile();

		assertEquals(true, flag);
	}

	@Test(description = "Verify that once we enter the email and waba is not enable then enable waba pop up is showing or not ", priority = 286)
	public void VerifyEnableWabaPopUp() throws FileNotFoundException, InterruptedException, IOException {

		flag = PlansPage.verifyEnableWabaPopUp();

		assertEquals(true, flag);
	}

	@Test(description = "Verify login with invalid store id", priority = 287)
	public void VerifyInvalidLogin() throws FileNotFoundException, InterruptedException, IOException {
		flag = CommonFunctions.verifyInvalidLogin();
		assertEquals(true, flag);
	}

	@Test(description = "Verify login with unavailable shop id", priority = 288)
	public void VerifyUnavailableLogin() throws InterruptedException, FileNotFoundException, IOException {
		flag = CommonFunctions.verifyUnavailableLogin();
		assertEquals(true, flag);
	}

	@Test(description = "Verify login with valid shop id" + "Verify login with Invalid Email id", priority = 289)
	public void VerifyInValidEmail() throws InterruptedException, FileNotFoundException, IOException {
		flag = CommonFunctions.verifyInValidEmail();
		assertEquals(true, flag);
	}

	@Test(description = "verify that when we go to campaign template section  all template ,created by me , default all this filter option is showing or not ", priority = 290)
	public void VerifyFilterOption() throws Exception {
		flag = CommonFunctions.verifyMarketCampaignsPage();
		if (flag) {
			flag = CampaignsPage.verifyFilteroptionCampaign();
		}
		assertEquals(true, flag);
	}

	@Test(description = "verify that all the default template is showing or not when we select default filter ", priority = 291)
	public void VerifyDefaultFilteroptionCampaign() throws Exception {
		flag = CommonFunctions.verifyMarketCampaignsPage();
		if (flag) {
	...
	@Test(description = "verify that all the created by me  template is showing or not when we select created by me  filter ", priority = 292)
	public void VerifyCreatedFilteroptionCampaign() throws Exception {
		flag = CommonFunctions.verifyMarketCampaignsPage();
		if (flag) {
	...
	@Test(description = "verify Run campaign ", priority = 293)
	public void VerifyRunCampaign() throws Exception {
		flag = CommonFunctions.verifyMarketCampaignsPage();
		if (flag) {
			flag = CampaignsPage.verifyRunCampaign();
		}
		assertEquals(true, flag);
	}

	@Test(description = "verify that when user is creating a template and if template contains custom variable and button url with suffix then sample variable section is showing or not ", priority = 294)
	public void VerifycreateCutomtemplateWithSuffixandDelete() throws Exception {
		flag = CommonFunctions.verifyMarketCampaignsPage();
		if (flag) {
			flag = CampaignsPage.verifycreateCutomtemplateWithSuffixandDelete();
		}
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify whether View campaigns button is clickable or not"
			+ "Verify on clicking view campaigns button, it is redirecting to my campaigns list or not", priority = 296)
	public void VerifyViewCampaignandRedirection() throws InterruptedException, FileNotFoundException, IOException {
		CommonFunctions.verifyMarketCampaignsPage();
		flag = CampaignsPage.verifyViewCampaignandRedirection();
		assertEquals(true, flag);
	}

	@Test(description = "Verify on clicking download report we are able to get the respective campaign reports or not"
			+ "Verify if there are all the fields with the details of the customer in the downloaded report or not", priority = 297)
	public void VerifyDownloadReport() throws InterruptedException, FileNotFoundException, IOException {
		CommonFunctions.verifyMarketCampaignsPage();
		flag = CampaignsPage.verifyDownloadReport();
		assertEquals(true, flag);
	}
	...
	@Test(description = "when user checked the uncheck checkbox for Abandoned cart setting and save that setting then that check box should unchecked if user open the setting", priority = 300)
	public void VerifyAbcartCheckBoxUnchecked() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyTemplatesPage();
		flag = AutomationPage.verifyAbcartUserSettingsUncheck();
		assertEquals(true, flag);
	}
	...
	public void VerifyCrossSellCheckBoxChecked() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyTemplatesPage();
		flag = AutomationPage.verifyCrossSellUserSettingsCheck();
		assertEquals(true, flag);
	}
	...
	public void VerifyCrossSellCheckBoxUnchecked() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyTemplatesPage();
		flag = AutomationPage.verifyCrossSellUserSettingsUncheck();
		assertEquals(true, flag);
	}
...
//		CommonFunctions.verifyNewStoreLoginPage("NewSharedTeamInbox_Token");
	...
	public void VerifyDeselectCheckboxes() throws Exception {
		CommonFunctions.verifyPersonalWidgetPage();
		flag = WidgetPage.verifyDeselectCheckboxes();
		assertEquals(true, flag);
	}
	...
	public void VerifySendMessageinAB_CART() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyManualMessagingPage();
		flag = MessagingPage.verifySendmessageinAB_CART();
		assertEquals(true, flag);
	}
	...
	//@Test(description = "Verify if there are 2 tutorial videos available for Shared Team Inbox section", priority = 347)
	...
	//@Test(description = "Verify Enage plan Tour", groups = { "group2" }, priority = 363)
	public void VerifyEngagePlanTour() throws Exception {
		flag = PlansPage.verifyEngagePlanProductTour();
		assertEquals(true, flag);
	}

	//@Test(description = "Verify Growth plan Tour", groups = { "group2" }, priority = 364)
	public void VerifyGrowthPlanTour() throws Exception {
		flag = PlansPage.verifyGrowthPlanProductTour();
		assertEquals(true, flag);
	}

	//@Test(description = "Verify newfree plan Tour", groups = { "group2" }, priority = 365)
	public void VerifyNewFreePlanPlanTour() throws Exception {
		flag = PlansPage.verifyNewFreePlanProductTour();
		assertEquals(true, flag);
	}

	//@Test(description = "Verify skip button functionality and back and next button functionality", groups = {
			//"group2" }, priority = 366)
	public void VerifySkipTour() throws Exception {
		flag = PlansPage.verifySkipProductTour();
		assertEquals(true, flag);
	}
	...
	public void VerifyAbcartRecoveredisinNumofOrder() throws Exception {
		flag = CommonFunctions.verifyPersonalWidgetPage();
		if (flag) {
			flag = CustomersPage.verifyAbcartRecovered();
		}
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify if the user can enter value in Marketing campaign usage limit", priority = 372)
	public void CheckValidMarketingCampaign_MonthlyLimit()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyAdminConfigurtionPage();
		flag = SettingsPage.marketingCampaignUsageLimit();
		assertEquals(true, flag);
	}

	@Test(description = "Verify if the user can increase or decrease Marketing campaign limit using input spinners", priority = 373)
	public void CheckValidMarketingCampaign_MonthlyLimitUsingSpinner()
			throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyAdminConfigurtionPage();
		flag = SettingsPage.marketingCampaignUsageLimitUsingSpinner();
		assertEquals(true, flag);
	}

	@Test(description = "Verify the user should not be allowed to enter invalid value in Marketing campaign usage limit", priority = 374)
	public void checkInvalidMarketingCampaignUsageLimit()
			throws FileNotFoundException, InterruptedException, IOException, org.json.simple.parser.ParseException {
		CommonFunctions.verifyAdminConfigurtionPage();
		flag = SettingsPage.InvalidMarketingCampaignUsageLimitCheck();
		assertEquals(true, flag);
	}
	...
	@Test(description = "Verify if there are three columns displayed in the table (Name, Last\r\n"
			+ "updated time and Actions)")
	public void verifyTagsTabHasThreeColumns() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyWhatsappInboxPage();
		flag = WhatsappInboxPage.verifyTagsTabHasThreeColumns();
		assertEquals(true, flag);
	}
	
	@Test(description = "Verify if we can edit or delete any tags")
	public void verifyEditAndDeleteTags() throws FileNotFoundException, InterruptedException, IOException {
		CommonFunctions.verifyWhatsappInboxPage();
		flag = WhatsappInboxPage.verifyEditDeleteTags();
		assertEquals(true, flag);
	}
